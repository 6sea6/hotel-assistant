...
const HOTEL_EDITABLE_FIELDS = [
  ...
  },
  {
    ...
    type: 'string',
    required: false,
    description: '距离宾馆最近的地铁站名称，若无较近地铁站可留空'
  },
  {
    key: 'subway_distance',
    label: '最近地铁站距离',
    type: 'string',
    required: false,
    description: '到最近地铁站的距离数字字符串，0 表示无较近地铁站'
  },
  {
    key: 'transport_time',
    label: '公共交通时间',
  ...
  },
  {
    ...
    type: 'string',
    required: false,
    description: '如大床房、双床房、大床房/双床房、家庭房、三床房'
  },
  {
    ...
    type: 'string',
    required: false,
    description: '平台原始展示房型名，如三人间、商务双床房、豪华大床房'
  },
  {
    key: 'room_count',
    label: '入住人数',
  ...
  },
  {
    ...
    type: 'string',
    required: false,
    description: '早餐、退改、税费、接驳、优缺点等补充信息'
  },
  {
    key: 'is_favorite',
    label: '收藏状态',
...
const TEMPLATE_INFO_FIELDS = [
  ...
  { key: 'destination', label: '目的地', type: 'string', description: '来源模板目的地' },
  {
    ...
    label: '入住日期',
    type: 'YYYY-MM-DD|null',
    description: '来源模板入住日期'
  },
  {
    key: 'check_out_date',
    label: '离店日期',
    type: 'YYYY-MM-DD|null',
    description: '来源模板离店日期'
  },
  {
    key: 'room_count',
    label: '入住人数',
...
const getPaths = () => {
  ...
  return {
    // 数据文件夹相关
    POINTER_FILE: require('path').join(
      electron.app.getPath('appData'),
      DEFAULT_COMPARE_APP_FILES.pointerFileName
    ),
